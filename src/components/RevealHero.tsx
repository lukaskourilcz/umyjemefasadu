    ...
    >
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-0">
          ...
          >
            <span className="micro-label absolute right-0 top-0 whitespace-nowrap rounded-l-full py-2 pl-3.5 pr-1.5 font-bold" style={LABEL_STYLE}>
              {rh.labelBeforePrefix}
            </span>
            <span className="micro-label absolute left-0 top-0 whitespace-nowrap rounded-r-full py-2 pl-1.5 pr-3.5 font-bold" style={LABEL_STYLE}>
          ...
          <div
            ...
            style={{ opacity: "var(--p)" }}
          >
            <span className="micro-label absolute right-0 top-0 whitespace-nowrap rounded-l-full py-2 pl-3.5 pr-1.5 font-bold" style={LABEL_STYLE_AFTER}>
              {rh.labelAfterPrefix}
            </span>
            <span className="micro-label absolute left-0 top-0 whitespace-nowrap rounded-r-full py-2 pl-1.5 pr-3.5 font-bold" style={LABEL_STYLE_AFTER}>
              {rh.labelAfterSuffix}
            </span>
          </div>
        </div>
